...
class MainApp(MDApp):
    ...
    savage = SoundLoader.load("SAVAGE.mp3")
    responsibility = SoundLoader.load("TAKE RESPONSIBILITY.mp3")
    procrastination = SoundLoader.load("PROCRASTINATION.mp3")
    relentless = SoundLoader.load("RELENTLESS.mp3")
    feelings = SoundLoader.load("FEELINGS.mp3")
